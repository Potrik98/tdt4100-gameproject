...
public class ShaderLoader {
    public static ShaderProgram createShaderProgramFromResources(final String vertexShaderResource,
        ...
        try {
            final String vertexShaderSource = FileUtils.readInputStream(ShaderLoader.class
                    .getResourceAsStream(vertexShaderResource));
            final String fragmentShaderSource = FileUtils.readInputStream(ShaderLoader.class
                    .getResourceAsStream(fragmentShaderResource));
